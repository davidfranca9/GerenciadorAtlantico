...
from app.models import Agendamento, AgendamentoEmail, AgendamentoItem, Pedido, RespostaFabrica, ListaEmail, BaixaPedido  # noqa: E402
...
@pytest.fixture
def db():
    sessao = banco_em_memoria(Pedido, BaixaPedido, Agendamento, AgendamentoItem, AgendamentoEmail, RespostaFabrica, ListaEmail)
    sessao.add_all([
