...
def extrair_dados_crlv_com_gemini(caminho_arquivo: str) -> dict:
    prompt = (
        ...
        "Extraia os dados exatamente como aparecem no documento. "
        "Para categoria_veiculo, classifique o veiculo em uma das opcoes do enum com base no campo "
        "'ESPECIE/TIPO' (ex: caminhao trator/tracao = CAVALO, carga caminhao = TRUCK, semi-reboque = "
        "'SEMI-REBOQUE 1'). Para marca, use o valor mais proximo dentre as opcoes do enum (ignore "
