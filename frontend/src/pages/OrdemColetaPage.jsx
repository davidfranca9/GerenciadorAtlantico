  ...
  return <div className="ops-page">
    ...
    <div className="ops-content-grid">
      ...
      <aside className="document-panel">
        <div className="panel-label" style={{display:"flex",alignItems:"center",gap:6}}><Icon name="route" size={12}/>IMPORTAÇÃO INTELIGENTE</div>
    ...
    <div className="action-dock"><div><span>ETAPA FINAL</span><strong>{hasContracts && hasDriver ? "Tudo pronto para emitir" : "Conclua as etapas anteriores para emitir"}</strong></div><div className="action-buttons"><button className="btn-ghost" disabled={!!loadingAction} onClick={handleLimpar}><Icon name="trash" size={16}/>Limpar</button><button className="btn-primary" disabled={!!loadingAction || !hasContracts || !hasDriver} onClick={handleEnviarEmail}><Icon name="mail" size={16}/>{loadingAction==="email"?"Enviando...":"Enviar por e-mail"}</button></div></div>
  </div>;
}
